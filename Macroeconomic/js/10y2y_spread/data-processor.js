...
const DataProcessor = (function() {
    ...
    const CSV_URL = '../data/fred_10y2y_spread/10y2y_spread.csv';
        ...
        try {
            ...
            if (error.name === 'TypeError' && error.message === 'Failed to fetch') {
                throw new Error(
                    ...
                    '3. 然后访问: http://localhost:8088/display/10y2y_spread.html\n\n' +
                    '或者运行以下命令快速启动：\n' +
    ...
    function aggregateData(data, type) {
        ...
        data.forEach(point => {
            ...
            if (!grouped[key]) {
                grouped[key] = { sum: 0, count: 0, date: key };
            }
